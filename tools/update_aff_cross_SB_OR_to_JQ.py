...
# Cross product generator: SB x OR => JQ
# Description:
# - Left block `SB`: Permission subjunctive
# - Right block `OR`: Special reflexive object markers
# - Output flag `JQ`: Cross-product prefixes for SB x OR
