...
# Cross product generator: GH x Ob => HN
# Description:
# - Left block `GH`: GH
# - Right block `Ob`: Object markers
# - Output flag `HN`: Cross-product prefixes for GH x Ob
...
rule_left_raw = """
PFX GH Y 20
PFX GH 0 bwessili [^mn]
PFX GH 0 bwessili mu
PFX GH 0 otoli .
PFX GH 0 atali .
PFX GH 0 bwetutali .
PFX GH 0 bwemutali .
