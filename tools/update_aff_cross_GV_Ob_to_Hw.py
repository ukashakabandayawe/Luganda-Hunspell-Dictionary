...
# Cross product generator: GV x Ob => Hw
# Description:
# - Left block `GV`: GV
# - Right block `Ob`: Object markers
# - Output flag `Hw`: Cross-product prefixes for GV x Ob
...
rule_left_raw = """
PFX GV Y 20
PFX GV 0 lwessili [^mn]
PFX GV 0 lwessili mu
PFX GV 0 otoli .
PFX GV 0 atali .
PFX GV 0 lwetutali .
PFX GV 0 lwemutali .
