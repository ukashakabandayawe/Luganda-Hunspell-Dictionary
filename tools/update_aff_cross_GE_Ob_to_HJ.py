...
# Cross product generator: GE x Ob => HJ
# Description:
# - Left block `GE`: GE
# - Right block `Ob`: Object markers
# - Output flag `HJ`: Cross-product prefixes for GE x Ob
