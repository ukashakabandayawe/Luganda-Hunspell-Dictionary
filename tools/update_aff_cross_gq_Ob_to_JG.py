...
# Cross product generator: gq x Ob => JG
# Description:
# - Left block `gq`: gq
# - Right block `Ob`: Object markers
# - Output flag `JG`: Cross-product prefixes for gq x Ob
...
INSERT_BEFORE_FLAG = "HQ".strip() or None

rule_left_raw = """
PFX gq Y 19
PFX gq j lwenzi jj # It creates wenzija from stem "jja"
PFX gq 0 lwen [^jbnmlhprxq] # Person marker
PFX gq 0 lwem [b] # Person marker
PFX gq l lwend [l] # Person marker
PFX gq 0 lwetu . # Person marker
PFX gq 0 lwemu . # Person marker
PFX gq 0 lweba . # Person marker
PFX gq 0 lwegu .
PFX gq 0 lwegi .
PFX gq 0 lwezi .
PFX gq 0 lweki .
...
def generate_block():
    ...
    comment_line = "# Cross product of {} ({}) and {} ({}) to {}".format(
        "gq", left_desc, "Ob", right_desc, out_flag
    )
