...
# Cross product generator: GT x Ob => HW
# Description:
# - Left block `GT`: GT
# - Right block `Ob`: Object markers
# - Output flag `HW`: Cross-product prefixes for GT x Ob
