...
# Cross product generator: GB x Ob => HB
# Description:
# - Left block `GB`: GB
# - Right block `Ob`: Object markers
# - Output flag `HB`: Cross-product prefixes for GB x Ob
