...
# Cross product generator: PT x Ob => em
# Description:
# - Left block `PT`: PT
# - Right block `Ob`: Object markers
# - Output flag `em`: Cross-product prefixes for PT x Ob
