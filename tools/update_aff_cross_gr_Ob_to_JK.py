...
# Cross product generator: gr x Ob => JK
# Description:
# - Left block `gr`: gr
# - Right block `Ob`: Object markers
# - Output flag `JK`: Cross-product prefixes for gr x Ob
