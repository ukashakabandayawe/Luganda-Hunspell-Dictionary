...
# Cross product generator: PS x Ob => EM
# Description:
# - Left block `PS`: Present simple tense subject markers
# - Right block `Ob`: Object markers
# - Output flag `EM`: Cross-product prefixes for PS x Ob
